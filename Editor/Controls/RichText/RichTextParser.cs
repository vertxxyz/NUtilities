...
namespace Vertx
{
	internal static class RichTextParser
	{
		...
		public struct RichTextTag : IEqualityComparer<RichTextTag>
		{
			...
			public RichTextTag GetWithRemovedBold() =>
				new RichTextTag(tag, fontStyle == FontStyle.BoldAndItalic ? FontStyle.Italic : FontStyle.Normal, color, size, stringVariables);

			public RichTextTag GetWithAddedItalics() =>
				new RichTextTag(tag, fontStyle == FontStyle.Normal ? FontStyle.Italic : FontStyle.BoldAndItalic, color, size, stringVariables);

			public RichTextTag GetWithRemovedItalics() =>
				new RichTextTag(tag, fontStyle == FontStyle.BoldAndItalic ? FontStyle.Bold : FontStyle.Normal, color, size, stringVariables);
